...
urlpatterns = [
    ...
    path('actualizar_preparacion/', views.actualizar_preparacion, name='actualizar_preparacion'),
    path('obtener_preparacion/', views.obtener_preparacion, name='obtener_preparacion'),
]
